            ...
            <div class="card card-primary card-outline mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $laporanKegiatan->rencanaKegiatan->nama_kegiatan }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $laporanKegiatan->rencanaKegiatan->jenis_kegiatan }}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $laporanKegiatan->rencanaKegiatan->penanggung_jawab }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $laporanKegiatan->rencanaKegiatan->kelompok }}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $laporanKegiatan->rencanaKegiatan->desa }}"
                            readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-warning card-outline mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="evaluasi" class="form-control" rows="4" placeholder="Berikan evaluasi terhadap kegiatan...">{{ old('evaluasi', $laporanKegiatan->evaluasi) }}</textarea>
                        @error('evaluasi')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    @if (!empty($laporanKegiatan->dokumentasi))
                        <div class="mb-3">
                                            ...
                                            <div class="card-body p-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="remove_dokumentasi[]" value="{{ $dokumentasi }}"
                                                        id="remove_{{ $index }}">
                            ...
                            <small class="form-text text-muted">Centang gambar yang ingin dihapus, lalu upload gambar baru
                                di bawah</small>
                        </div>
                    @endif
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteBtn.addEventListener('click', function(e) {
                ...
                if (removeDocs.length > 0) {
                    const docNames = Array.from(removeDocs).map(cb => cb.nextElementSibling.textContent
                        .trim());
                    if (!confirm(
                            `Anda akan menghapus ${removeDocs.length} dokumentasi:\n${docNames.join(', ')}\n\nLanjutkan?`
                        )) {
                        e.preventDefault();
                    }
                }
